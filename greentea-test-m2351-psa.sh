...
rm -rdf SECURE_IMAGE_STAGE
mkdir -p SECURE_IMAGE_STAGE
cp TARGET_IGNORE/NU_PFM_M2351_S/IAR-DEVELOP/spm_smoke/* SECURE_IMAGE_STAGE
cp TARGET_IGNORE/NU_PFM_M2351_S/IAR-DEVELOP/spm_client/* SECURE_IMAGE_STAGE
cp TARGET_IGNORE/NU_PFM_M2351_S/IAR-DEVELOP/spm_server/* SECURE_IMAGE_STAGE
cp TARGET_IGNORE/NU_PFM_M2351_S/IAR-DEVELOP/crypto_access_control/* SECURE_IMAGE_STAGE
cp TARGET_IGNORE/NU_PFM_M2351_S/IAR-DEVELOP/tfm/* SECURE_IMAGE_STAGE
mbed test -m NU_PFM_M2351_NS -t ARMC6 -n $TEST_LIST > m2351-psa_iar-s_armc6-ns.log
...
cp TARGET_IGNORE/NU_PFM_M2351_S/IAR-DEVELOP/crypto_access_control/* SECURE_IMAGE_STAGE
cp TARGET_IGNORE/NU_PFM_M2351_S/IAR-DEVELOP/tfm/* SECURE_IMAGE_STAGE
mbed test -m NU_PFM_M2351_NS -t IAR -n $TEST_LIST > m2351-psa_iar-s_iar-ns.log
