...
mbed test -m NU_M2354_NPSA_NS -t ARMC6 -n $TEST_LIST > m2354-nopsa_armc6-s_armc6-ns.log
...
mkdir -p SECURE_IMAGE_STAGE
cp TARGET_IGNORE/NU_M2354_NPSA_S/ARMC6-DEVELOP/NuMaker-mbed-TZ-secure-example/* SECURE_IMAGE_STAGE
mbed test -m NU_M2354_NPSA_NS -t GCC_ARM -n $TEST_LIST > m2354-nopsa_armc6-s_gcc-ns.log
...
mbed test -m NU_M2354_NPSA_NS -t ARMC6 -n $TEST_LIST > m2354-nopsa_gcc-s_armc6-ns.log
...
mkdir -p SECURE_IMAGE_STAGE
cp TARGET_IGNORE/NU_M2354_NPSA_S/GCC_ARM-DEVELOP/NuMaker-mbed-TZ-secure-example/* SECURE_IMAGE_STAGE
mbed test -m NU_M2354_NPSA_NS -t GCC_ARM -n $TEST_LIST > m2354-nopsa_gcc-s_gcc-ns.log
...
mbed test -m NU_M2354_NPSA_NS -t ARMC6 -n $TEST_LIST > m2354-nopsa_iar-s_armc6-ns.log
...
mkdir -p SECURE_IMAGE_STAGE
cp TARGET_IGNORE/NU_M2354_NPSA_S/IAR-DEVELOP/NuMaker-mbed-TZ-secure-example/* SECURE_IMAGE_STAGE
mbed test -m NU_M2354_NPSA_NS -t IAR -n $TEST_LIST > m2354-nopsa_iar-s_iar-ns.log
